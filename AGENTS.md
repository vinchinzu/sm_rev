...
- If you move functions out of a monolithic bank file, update the bank-origin lookup doc in [docs/bank_origin_map.md](docs/bank_origin_map.md) so future debugging can jump back to the original source quickly.
