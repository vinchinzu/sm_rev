...
| `src/eproj_combat.c` | `../sm/src/sm_86.c` | Remaining combat-facing enemy-projectile families from the old Bank 86 file after the core/environment/Tourian/Torizo peels. This includes the Skree/Draygon/Crocomire/Kraid/Mini-Kraid clusters, pirate/Ceres/Shaktool projectile families, Ki-Hunter/Kago/Maridia/WS robot/N00b tube/spore families, Botwoon/Yapping Maw handlers, and the pickup/death-explosion/sparks tail. |
