// Samus collision basics: movement-facing displacement helpers,
// no-collision position updates, slope alignment, and wall-jump gates.
// Advanced block-map / pose-change collision lives in
// samus_collision_advanced.c.
