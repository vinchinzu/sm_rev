...
uint16 DecompressToMem(uint32 src, uint8 *decompress_dst);
...
const uint8 *PlmInstr_SpawnEproj(const uint8 *plmp, uint16 k);
const uint8 *PlmInstr_SpawnEyeDoorSmokeProjectile(const uint8 *plmp, uint16 k);
const uint8 *PlmInstr_SpawnEyeDoorSweatEproj(const uint8 *plmp, uint16 k);
const uint8 *PlmInstr_SpawnFourMotherBrainGlass(const uint8 *plmp, uint16 k);
const uint8 *PlmInstr_SpawnN00bTubeCrackEproj(const uint8 *plmp, uint16 k);
...
const uint8 *PlmInstr_WakeEprojAtPlmPos(const uint8 *plmp, uint16 k);
...
const uint8 *EprojInstr_GotoDependingOnXDirection(uint16 k, const uint8 *epjp);
...
Pair_Bool_Amt Samus_CalcBaseSpeed_NoDecel_X(uint16 k);
...
Pair_Bool_Amt BlockColl_Handle_Horiz(int32 amt);
Pair_Bool_Amt BlockColl_Handle_Vert_LeftToRight(int32 amt);
Pair_Bool_Amt BlockColl_Handle_Vert_RightToLeft(int32 amt);
