...
void SetupPpu_Intro(void) {  // 0x8B80DA
  ...
  reg_COLDATA[2] = 0x80;
  reg_MOSAIC = 0;
  memset7E((uint16*)&ram3000, 0x2F, 0x7FE);
  oam_next_ptr = 0;
  cinematic_var5 = 0;
  cinematic_var6 = 256;
  cinematic_var7 = 0;
...
CoroutineRet InitializeIoDisplayLogo_Async(void) {  // 0x8B9146
  ...
  WriteReg(SETINI, 0);
  reg_SETINI = 0;
  DecompressToMem(0x9580D8, gfx_buf_15000);
  WriteReg(VMADDL, 0);
...
void CreditsObject_Func1(uint16 j) {  // 0x8B99C1
  ...
  int n = 31;
  const uint16 *src = (const uint16*)((uint8*)&ram7F_start + *((uint16 *)RomPtr_8C(j) + 1));
  do {
...
void LoadTitleSequenceGraphics(void) {  // 0x8B9B87
  ...
  DecompressToMem(0x94E000, (uint8*)&ram7F_start);
  DecompressToMem(0x96FC04, gfx_buf_14000);
  DecompressToMem(0x9580D8, gfx_buf_15000);
  DecompressToMem(0x95A5E1, gfx_buf_19000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
...
void CinematicFunction_Intro_Initial(void) {  // 0x8BA395
  ...
  DecompressToMem(0x95f90e, (uint8*)&ram7F_start);
  DecompressToMem(0x95d089, gfx_buf_18000);
  DecompressToMem(0x9788cc, gfx_buf_19000);
  DecompressToMem(0x96ff14, gfx_buf_19800);
  DecompressToMem(0x95e4c2, gfx_buf_1b800);
  DecompressToMem(0x978d12, intro_gfx_buf_1e000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
  ...
  WriteReg(MDMAEN, 2);
  DecompressToMem(0x95D713, gfx_buf_1a000);
  EnableNMI();
  screen_fade_delay = 3;
...
void CinematicFunction_Intro_Func54(void) {  // 0x8BBCA0
  ...
  DecompressToMem(0x95A82F, (uint8*)&ram7F_start);
  DecompressToMem(0x96FE69, gfx_buf_14000);
  DecompressToMem(0x96D10A, gfx_buf_15000);
...
void CinematicFunction_Intro_Func86(void) {  // 0x8BC699
  ...
  for (int i = 656; i >= 0; i -= 2)
    *(uint16 *)((uint8 *)&cinematic_var5 + (uint16)i) = 0;
  DecompressToMem(0x978ADB, gfx_buf_19000);
  DecompressToMem(0x96EC76, gfx_buf_15000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0);
...
void CinematicFunctionEscapeFromCebes(void) {  // 0x8BD480
  ...
  DecompressToMem(0x98bcd6, (uint8*)&ram7F_start);
  DecompressToMem(0x99a56f, gfx_buf_14000);
  DecompressToMem(0x99d17e, gfx_buf_18000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
  ...
  WriteReg(MDMAEN, 2);
  DecompressToMem(0x988304, gfx_buf_18000);
  DecompressToMem(0x95a82f, (uint8*)&ram7F_start);
  DecompressToMem(0x96fe69, gfx_buf_14000);
  uint16 v3 = 768;
  do {
    *(uint16 *)(gfx_buf_14000 + v3) = 0x8c8c;
    v3 += 2;
  } while ((int16)(v3 - 0x4000) < 0);
  DecompressToMem(0x98b5c1, intro_gfx_buf_1e000);
  DecompressToMem(0x98b857, intro_gfx_buf_1e800);
  DecompressToMem(0x98baed, intro_gfx_buf_1f000);
  DecompressToMem(0x98bccd, intro_gfx_buf_1f800);
  DecompressToMem(0x97e7de, (uint8*)&tile_table);
  DecompressToMem(0x99d65b, (uint8*)tilemap_stuff);
  DecompressToMem(0x99d932, (uint8*)ram6000);
  WriteRegWord(M7A, 0x100);
  reg_M7A = 256;
  WriteRegWord(M7B, 0);
  reg_M7B = 0;
...
void CinematicFunction_Intro_Func112(void) {  // 0x8BD731
  ...
  WriteReg(MDMAEN, 2);
  DecompressToMem(0x98ED4F, (uint8*)tilemap_stuff);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
...
void CinematicFunction_Intro_Func115(void) {  // 0x8BD837
  ...
  WriteReg(MDMAEN, 2);
  DecompressToMem(0x999101, (uint8*)ram6000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
...
void CinematicFunction_Intro_Func126(void) {  // 0x8BDE80
  ...
  DecompressToMem(0x979803, (uint8*)&ram7F_start);
  DecompressToMem(0x97B957, (uint8*)tilemap_stuff);
  DecompressToMem(0x97D7FC, (uint8*)ram6000);
  DecompressToMem(0x97E7DE, intro_gfx_buf_1c000);
  DecompressToMem(0x9796F4, intro_gfx_buf_1e000);
  DecompressToMem(0x97F987, gfx_buf_14000);
  DecompressToMem(0x99DA9F, intro_gfx_buf_1e800);
  DecompressToMem(0x99DAB1, intro_gfx_buf_1f000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0x20);
  WriteReg(VMAIN, 0x80);
  ...
  DecompressToMem(0x99E089, (uint8*)ram6000);
  DecompressToMem(0x99ECC4, (uint8*)extra_enemy_ram8000);
  ...
  DecompressToMem(0x97EEFF, (uint8*)&ram7F_start);
